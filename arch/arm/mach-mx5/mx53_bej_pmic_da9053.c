...
/*
 * mx53_bej_pmic_da9053.c  --  i.MX53 SMD driver for pmic da9053
 */
...
static struct regulator_init_data da9052_regulators_init[] = {
	...
	DA9052_LDO(DA9052_LDO34_VOLT_UPPER,
		DA9052_LDO34_VOLT_LOWER, "DA9052_LDO3", 3000, 0, NULL),
	DA9052_LDO(DA9052_LDO34_VOLT_UPPER,
	...
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO6", 1300, 0, NULL),
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
	...
	DA9052_LDO(DA9052_LDO9_VOLT_UPPER,
		DA9052_LDO9_VOLT_LOWER, "DA9052_LDO9", 1500,
		ARRAY_SIZE(ld09_consumers), ld09_consumers),
	DA9052_LDO(DA9052_LDO567810_VOLT_UPPER,
		DA9052_LDO567810_VOLT_LOWER, "DA9052_LDO10", 1300, 0, NULL),
	...
	DA9052_LDO(DA9052_BUCK_MEM_VOLT_UPPER,
		DA9052_BUCK_MEM_VOLT_LOWER, "DA9052_BUCK_MEM", 1525, 0, NULL),
...
static struct regulator_consumer_supply mx53_bej_vmmc_consumers[] = {
	REGULATOR_SUPPLY("vmmc", "sdhci-esdhc-imx.0"),
	REGULATOR_SUPPLY("vmmc", "sdhci-esdhc-imx.1"),
	REGULATOR_SUPPLY("vmmc", "sdhci-esdhc-imx.2"),
};

static struct regulator_init_data mx53_bej_vmmc_init = {
	.num_consumer_supplies = ARRAY_SIZE(mx53_bej_vmmc_consumers),
	.consumer_supplies = mx53_bej_vmmc_consumers,
};

static struct fixed_voltage_config mx53_bej_vmmc_reg_config = {
	.supply_name		= "vmmc",
	.microvolts		= 3300000,
	.gpio			= -1,
	.init_data		= &mx53_bej_vmmc_init,
};

static struct platform_device mx53_bej_vmmc_reg_devices = {
	.name	= "reg-fixed-voltage",
	.id	= 3,
	.dev	= {
		.platform_data = &mx53_bej_vmmc_reg_config,
	},
};

static struct regulator_consumer_supply mx53_bej_cpu_vddvpu_consumers[] = {
	REGULATOR_SUPPLY("cpu_vddvpu", NULL),
};

static struct regulator_init_data mx53_bej_cpu_vddvpu_init = {
	.num_consumer_supplies = ARRAY_SIZE(mx53_bej_cpu_vddvpu_consumers),
	.consumer_supplies = mx53_bej_cpu_vddvpu_consumers,
};

static struct fixed_voltage_config mx53_bej_cpu_vddvpu_reg_config = {
	.supply_name		= "cpu_vddvpu",
	.microvolts		= 3300000,
	.gpio			= -1,
	.init_data		= &mx53_bej_cpu_vddvpu_init,
};

static struct platform_device mx53_bej_cpu_vddvpu_reg_devices = {
	.name	= "reg-fixed-voltage",
	.id	= 2,
	.dev	= {
		.platform_data = &mx53_bej_cpu_vddvpu_reg_config,
	},
};
...
#endif
	platform_device_register(&mx53_bej_vmmc_reg_devices);
	platform_device_register(&mx53_bej_cpu_vddvpu_reg_devices);
...
int __init mx53_bej_init_da9052(void)
{
