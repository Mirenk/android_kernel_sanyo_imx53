...
#define MX53_SMD_LCD_CTL1			(2*32 + 0)	/*GPIO_3_0 */
#define MX53_SMD_LCD_CTL2			(1*32 + 29)	/* GPIO_2_29 */
...
void mx53_smd_lcd_ctl(void)
{
printk("mx53_smd_lcd_ctl\n");
	gpio_set_value(MX53_SMD_LCD_CTL1, 1);
	msleep(15);
	gpio_set_value(MX53_SMD_LCD_CTL2, 1);
}
EXPORT_SYMBOL(mx53_smd_lcd_ctl);
...
static void __init mx53_smd_io_init(void)
{
	...
	gpio_request(MX53_SMD_LCD_CTL1, "lcd ctr1");
	gpio_direction_output(MX53_SMD_LCD_CTL1, 0);
	gpio_request(MX53_SMD_LCD_CTL2, "lcd ctr2");
	gpio_direction_output(MX53_SMD_LCD_CTL2, 0);
}
