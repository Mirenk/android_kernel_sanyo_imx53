...
static struct da9052_onkey_data da9052_onkey_static;
...
//	da9052_onkey = kzalloc(sizeof(*da9052_onkey), GFP_KERNEL);
	da9052_onkey = &da9052_onkey_static;
...
static int da9052_onkey_suspend(struct platform_device *dev, pm_message_t state)
{
#if 1
	struct da9052_onkey_data *da9052_onkey = &da9052_onkey_static;
	struct da9052_ssc_msg msg;

	da9052_lock(da9052_onkey->da9052);
	msg.addr = DA9052_IRQMASKB_REG;
	da9052_onkey->da9052->read(da9052_onkey->da9052, &msg);
	da9052_onkey->irqmaskb = msg.data;
	msg.data = 0xff;
...
static int da9052_onkey_resume(struct platform_device *dev)
{
#if 1
	struct da9052_onkey_data *da9052_onkey = &da9052_onkey_static;
	struct da9052_ssc_msg msg;
	...
	da9052_lock(da9052_onkey->da9052);
	msg.addr = DA9052_IRQMASKB_REG;
	msg.data = da9052_onkey->irqmaskb;
	da9052_onkey->da9052->write(da9052_onkey->da9052, &msg);
	da9052_unlock(da9052_onkey->da9052);
#endif
