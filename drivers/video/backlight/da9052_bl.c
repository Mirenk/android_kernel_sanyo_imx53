...
#define DA9052_LED3_PRESENT	0

/*Sanyo*/
/*#define DA9052_MAX_BRIGHTNESS	0xA0*//*0xFF*/
#define DA9052_MAX_BRIGHTNESS	0x5F /*PWM Max*/

/*Sanyo*/
#define DA9052_LED1_MAX_BRIGHTNESS 0xB0
#define DA9052_LED2_MAX_BRIGHTNESS 0xE0
#define DA9052_LED3_MAX_BRIGHTNESS 0xA0 /*dummy*/
...
/*Sanyo*/
		led_current = DA9052_LED1_MAX_BRIGHTNESS;
		led_pwm = DA9052_LED1CONT_REG;
	break;
	case LED2:
...
/*Sanyo*/
		led_current = DA9052_LED2_MAX_BRIGHTNESS;
		led_pwm = DA9052_LED2CONT_REG;
	break;
	case LED3:
...
/*Sanyo*/
		led_current = DA9052_LED3_MAX_BRIGHTNESS;
		led_pwm = DA9052_LED3CONT_REG;
	break;
	default:
		return -EIO;
	}
