...
extern void mx53_bej_lcd_5v_ctl(int on);
extern void mx53_bej_lcd_reset_ctl(int on);
extern void mx53_bej_lcd_power_en(int on);
#endif
...
printk("ldb_disable\n");
	mdelay(100);
	mx53_bej_lcd_power_en(0);
	mx53_bej_lcd_reset_ctl(0);
#endif
...
#ifdef CONFIG_MACH_MX53_BEJ
printk("ldb_enable\n");
	mx53_bej_lcd_power_en(1);
	mx53_bej_lcd_reset_ctl(1);
	mdelay(100);
	mx53_bej_lcd_5v_ctl(1);
#endif
