...
#else
#define BAT_MANUFACTURER			"Panasonic"
#define BAT_TYPE				POWER_SUPPLY_TECHNOLOGY_LIPO
#ifdef USE_MAX17058
#define DA9052_LOOK_UP_TABLE_SIZE		20
#else
#define DA9052_LOOK_UP_TABLE_SIZE		18
#endif
#define DA9052_NO_OF_LOOKUP_TABLE		2
#endif
...
#else
#define DA9052_ILLEGAL_BATTERY_DETECT		0
#define DA9052_BAT_FILTER_HYS			0
#endif
...
#ifdef USE_MAX17058
	/* For temperature 20 degree celisus*/
	{
	{4000, 100},
	{3980, 90},
	{3950, 85},
